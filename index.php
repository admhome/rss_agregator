<?php
	...
	$smarty->assign('page_title',$seo_title); // title of the page
	...
	$items_number = mysql_num_rows(mysql_query("SELECT item_category_id FROM feeditems WHERE item_published='1'"));
	...
	if ($friendly_urls == 1) {
	$pagination->setLink("page-%s"); // set the link of the pages
	} else {
	$pagination->setLink("index.php?page=%s"); // set the link of the pages
	}
